...
Logger log = new LoggerConfiguration()
    ...
    .Enrich.FromLogContext() // harici property ler kullanılmak isteniyorsa bu ayar verilerek context den beslenmesini belirtiyoruz.
...
builder.Services.AddAuthentication(JwtBearerDefaults.AuthenticationScheme)
    .AddJwtBearer(options =>
    {
        options.TokenValidationParameters = new()
        {
            ...
            NameClaimType = ClaimTypes.Name // JWT üzerinde Name claim e karşılık gelen değeri User.Identity.Name propertysinden elde edebiliriz.
        };
    });
